...
#  
#  Может использоваться для переопределения шаблонов из notebook.templates.
#  Default: []
...
## Предоставьте параметры SSL для HTTPServer tornado. Подробности смотрите в
#  документации tornado.
#  Default: {}
...
## Стоит ли доверять или нет Х-схеме/х-перенаправлению-прото и X-реал-
#  ip/х-перенаправлению-для заголовков, загружаемых по потоку обратного прокси-
...
#  Default: 'aleksandrkovalenko'
# c.Session.username = 'aleksandrkovalenko'
...
#  Choices: any of ['md5', 'sha256', 'sha3_384', 'sha3_512', 'sha224', 'sha384', 'blake2b', 'sha1', 'sha512', 'sha3_224', 'sha3_256', 'blake2s']
#  Default: 'sha256'
